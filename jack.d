...
alias JackLatencyRange jack_latency_range_t;
alias JackPortID jack_port_type_id_t;
interface JackPort
{
    JackPortBuffer getBuffer(jack_nframes_t nframes);
...
alias JackNFrames jack_nframes_t;
alias JackTime jack_time_t;
alias int function(JackNFrames nframes, Object data) JackProcessCallback;
...
alias void function(Object data) JackShutdownCallback;
...
interface JackClient
{
    ...
    JackPort portRegister(string port_name, string port_type, uint flags, uint buffer_size);
    ...
    JackNamesArray getPorts(string pattern, string pattern_type, uint flags);
    ...
    // Callbacks
    void setProcessCallback(JackProcessCallback callback, Object data);
...
interface JackServer
{
    JackVersion getVersion();
    string getVersionString();
    JackClient clientOpen(string name, JackOptions options, out JackStatus status, ...);
